...
class Book(models.Model):
    ...
    # Fields
    name = models.CharField(_('Book Name'),
                            max_length=100,
                            help_text=_("Name of the book."))
    description = models.TextField(_('Description'),
                                   blank=True,
                                   help_text=_("Description about the book."))
    year = models.DateField(_('Publish Year'),
                            blank=True,
                            null=True,
                            help_text=_('Year of the publishing the book.'))
    edition_number = models.IntegerField(_('Edition Number'),
                                         blank=True,
                                         null=True,
                                         help_text=_('Number of the book edition.'))
    volume = models.IntegerField(_('Volume Number'),
                                 blank=True,
                                 null=True,
                                 help_text=_('Number of the book volume.'))
    part = models.IntegerField(_('Part Number'),
                               blank=True,
                               null=True,
                               help_text=_('Number of the book part.'))
    page_quantity = models.IntegerField(_('Page Quantity'),
                                        help_text=_('Quantity of the book pages.'))
    is_copyright = models.BooleanField(_('Is copyright?'),
                                       default=False,
    ...
    timestamp = models.DateTimeField(_('Created Timestamp'),
                                     auto_now_add=True)
...
class BookHistory(models.Model):
    ...
    # DATABASE FIELDS
    # Foreign Keys
    editor = models.ForeignKey(get_user_model(),
                               on_delete=models.PROTECT,
